...
class InserterRow1
{
    public InserterRow1()
    {
        ...
        try
        {
           ...
           PreparedStatement pstmt=conn.prepareStatement("INSERT INTO DEPT VALUES('"+vDEPTNO+"','"+vDNAME+"','"+vLOC+"')");  
...
public class RecordInserter1 
{
    public static void main(String args[])
    {
        InserterRow1 ic1=new InserterRow1();
    }
}
